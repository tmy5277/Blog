$( window ).on( "load", function(){
    waterfall('main','pin');
    var dataInt = {"data":[{"src":'31.jpg'},{"src":'32.jpg'},{"src":'33.jpg'},{"src":'34.jpg'},{"src":'35.jpg'},{"src":'36.jpg'},{"src":'37.jpg'},{"src":'38.jpg'}]}
...
function waterfall(parent,pin){
    ...
    $aPin.each( function( index, value ){
        ...
        if( index < num ){
            ...
            pinHArr[ minHIndex ] += $aPin.eq( index ).height()+14;//更新添加了块框后的列高
